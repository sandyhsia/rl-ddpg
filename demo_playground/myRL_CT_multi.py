    ...
    try:
            for episode in range(EPISODE):
                    ...
                    for step in range(STEP):
                            ...
                            for i in range(car_agent_num):
                                    # print i
                                    agent_array[i].perceive(state[i], action_array.pop(0), reward[i], next_state[i], done[i])
                            # print "reward:", reward
            ...
            if save_request == 1:
                    ...
                    if input == 'y':
                            ...
                            s1.save(agent_array[0].session, CHECKPOINT_DIR + '/'+'A'+str(i)+'.chkp', global_step =global_t+episode)
